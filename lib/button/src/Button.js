    ...
    const cssVarsRef = (0, vue_1.computed)(() => {
      ...
      if (text) {
        ...
        colorProps = {
          ...
          '--n-color-disabled':
            color || self[(0, _utils_1.createKey)('colorDisabled', mergedType)],
          '--n-ripple-color':
            color || self[(0, _utils_1.createKey)('rippleColor', mergedType)],
          '--n-text-color':
            textColor ||
    ...
    const themeClassHandle = inlineThemeDisabled
      ? (0, _mixins_1.useThemeClass)(
          ...
          (0, vue_1.computed)(() => {
            ...
            if (textColor) hash += 'k' + (0, _utils_1.color2Class)(textColor)
              ...
              (children) =>
                ...
                (0, vue_1.h)(
                  'span',
                  {
                    ...
                    style: {
                      margin: (0, _utils_1.isSlotEmpty)(this.$slots.default)
                        ? '0'
                        : ''
                    }
                  },

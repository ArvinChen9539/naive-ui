  ...
  setup(props, { slots }) {
    ...
    const uncontrolledValueRef = (0, vue_1.ref)(
      (_b =
        ...
        : slots.default
        ? (_d =
            (_c = (0, _utils_1.flatten)(slots.default())[0]) === null ||
            _c === void 0
              ? void 0
    ...
    function _handleNavResize(entry) {
      ...
      if (type === 'line' || type === 'bar') {
        if (
          ...
          ((_a = props.justifyContent) === null || _a === void 0
            ? void 0
            : _a.startsWith('space'))
        ) {
      ...
      if (type !== 'segment') {
        deriveScrollShadow(
          (_b = xScrollInstRef.value) === null || _b === void 0
            ? void 0
            : _b.$el
        )
      }
    ...
    const scrollContent = () => {
      ...
      return (0, vue_1.h)(
        ...
        isCard && addable
          ...
          : tabs,
        isCard
          ? (0, vue_1.h)('div', { class: `${mergedClsPrefix}-tabs-pad` })
          : null,
        isCard
          ? null
          : (0, vue_1.h)('div', {
    ...
    return (0, vue_1.h)(
      ...
      (0, vue_1.h)(
        ...
        isSegment
          ? (0, vue_1.h)(
              'div',
              { class: `${mergedClsPrefix}-tabs-rail`, ref: 'tabsRailElRef' },
              showPane
                ? tabPaneChildren.map((tabPaneVNode, index) => {
                    renderNameListRef.value.push(tabPaneVNode.props.name)
                    return (0, vue_1.h)(

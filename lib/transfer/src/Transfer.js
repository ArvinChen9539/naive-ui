      ...
      cssVars: (0, vue_1.computed)(() => {
        ...
        const {
          ...
          self: {
            ...
            [(0, cssr_1.createKey)('extraFontSize', size)]: extraFontSize,
            [(0, cssr_1.createKey)('fontSize', size)]: fontSize,
            [(0, cssr_1.createKey)('titleFontSize', size)]: titleFontSize,
            [(0, cssr_1.createKey)('itemHeight', size)]: itemHeight,
            [(0, cssr_1.createKey)('headerHeight', size)]: headerHeight
          }
        } = themeRef.value
        return {

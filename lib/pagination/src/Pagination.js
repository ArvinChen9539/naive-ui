    ...
    const cssVarsRef = (0, vue_1.computed)(() => {
      ...
      const {
        self: {
          ...
          [(0, _utils_1.createKey)('selectMargin', size)]: selectMargin,
          [(0, _utils_1.createKey)('jumperFontSize', size)]: jumperFontSize,
          [(0, _utils_1.createKey)('prefixMargin', size)]: prefixMargin,
          [(0, _utils_1.createKey)('suffixMargin', size)]: suffixMargin,
          [(0, _utils_1.createKey)('itemSize', size)]: itemSize,
          [(0, _utils_1.createKey)('buttonIconSize', size)]: buttonIconSize,
          [(0, _utils_1.createKey)('itemFontSize', size)]: itemFontSize,
          [`${(0, _utils_1.createKey)('itemMargin', size)}Rtl`]: itemMarginRtl,
          [`${(0, _utils_1.createKey)('inputMargin', size)}Rtl`]: inputMarginRtl
        },
                      ...
                      case 'fast-forward':
                        ...
                        const fastForwardNode = this.fastForwardActive
                          ...
                          : (0, vue_1.h)(
                              ...
                              {
                                default: () =>
                                  (0, vue_1.h)(icons_1.MoreIcon, null)
                              }
                            )
                        if (renderLabel) {
                          contentNode = renderLabel({
          ...
          case 'quick-jumper':
            return !simple && showQuickJumper
              ? (0, vue_1.h)(
                  ...
                  goto
                    ? goto()
                    : (0, _utils_1.resolveSlot)(this.$slots.goto, () => [
                        locale.goto
                      ]),
                  (0, vue_1.h)(input_1.NInput, {
                    value: jumperValue,

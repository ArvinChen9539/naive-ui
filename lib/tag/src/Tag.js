...
exports.default = (0, vue_1.defineComponent)({
    ...
    const cssVarsRef = (0, vue_1.computed)(() => {
      ...
      const {
        ...
        self: {
          ...
          closeBorderRadius,
          fontWeightStrong,
          [(0, _utils_1.createKey)('colorBordered', type)]: colorBordered,
          [(0, _utils_1.createKey)('closeSize', size)]: closeSize,
          [(0, _utils_1.createKey)('closeIconSize', size)]: closeIconSize,
          ...
          [(0, _utils_1.createKey)('closeIconColor', type)]: closeIconColor,
  ...
  render() {
    ...
    const iconNode = (0, _utils_1.resolveWrappedSlot)(
      ...
      (children) =>
        children &&
        (0, vue_1.h)('div', { class: `${mergedClsPrefix}-tag__icon` }, children)
    )
    return (0, vue_1.h)(
      'div',
      {

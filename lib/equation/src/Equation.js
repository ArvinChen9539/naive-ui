  ...
  setup(props) {
    ...
    const extractedHtmlInfo = (0, vue_1.computed)(() => {
      ...
      const outerHtml =
        ((_a =
          props.katex ||
          (configProviderContext === null || configProviderContext === void 0
            ? void 0
            : configProviderContext.mergedKatexRef.value)) === null ||
        _a === void 0
          ? void 0
          : _a.renderToString(
              props.value || '',
              Object.assign({ throwOnError: false }, props.katexOptions)
            )) || 'no katex provided'
      ...
      const wrapperTag =
        (matchResult === null || matchResult === void 0
          ...
          : matchResult[1]) || 'span'
      const wrapperClass =
        matchResult === null || matchResult === void 0 ? void 0 : matchResult[2]

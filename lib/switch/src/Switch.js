    ...
    const cssVarsRef = (0, vue_1.computed)(() => {
      ...
      const {
        self: {
          ...
          [(0, _utils_1.createKey)('railBorderRadius', size)]: railBorderRadius,
  ...
  render() {
    ...
    return (0, vue_1.h)(
      ...
      (0, vue_1.h)(
        ...
        (0, _utils_1.resolveWrappedSlot)(checkedSlot, (checkedSlotChildren) =>
        ...
        (0, vue_1.h)(
          ...
          (0, _utils_1.resolveWrappedSlot)(iconSlot, (icon) =>
            (0, _utils_1.resolveWrappedSlot)(checkedIconSlot, (checkedIcon) =>
              (0, _utils_1.resolveWrappedSlot)(
                uncheckedIconSlot,
                (uncheckedIcon) => {

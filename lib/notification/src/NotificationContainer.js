...
exports.NotificationContainer = (0, vue_1.defineComponent)({
  ...
  setup() {
    const { mergedThemeRef, mergedClsPrefixRef, wipTransitionCountRef } = (0,
    vue_1.inject)(context_1.notificationProviderInjectionKey)
    const selfRef = (0, vue_1.ref)(null)
    ;(0, vue_1.watchEffect)(() => {
      var _a, _b
      if (wipTransitionCountRef.value > 0) {
        ;(_a =
          selfRef === null || selfRef === void 0 ? void 0 : selfRef.value) ===
          null || _a === void 0
          ? void 0

      ...
      h(
        ...
        h(
          ...
          h(
            ...
            resolveSlot($slots['prev-year'], () => [h(FastBackwardIcon, null)])
          ),
          h(
            'div',
            {
            ...
            resolveSlot($slots['prev-month'], () => [h(BackwardIcon, null)])
          ),
          h(PanelHeader, {
          ...
          h(
            ...
            resolveSlot($slots['next-month'], () => [h(ForwardIcon, null)])
          ),
          h(
            'div',
            {
            ...
            resolveSlot($slots['next-year'], () => [h(FastForwardIcon, null)])
          )
        ),
        h(
          'div',

...
declare const _default: import('vue').DefineComponent<
  {
    readonly onUnstableColumnResize: import('vue').PropType<
      (
        resizedWidth: number,
        limitedWidth: number,
    ...
    readonly rowClassName: import('vue').PropType<
      string | import('./interface').CreateRowClassName<any>
    >
    readonly rowProps: import('vue').PropType<
      import('./interface').CreateRowProps<any>
    >
    readonly rowKey: import('vue').PropType<
      import('./interface').CreateRowKey<any>
    >
    readonly summary: import('vue').PropType<
    ...
    readonly scrollbarProps: import('vue').PropType<
      import('../..').ScrollbarProps
    >
    readonly renderCell: import('vue').PropType<
      (
        value: any,
        rowData: object,
        column: import('./interface').TableBaseColumn<
    ...
    >
    readonly renderExpandIcon: import('vue').PropType<
      () => import('vue').VNodeChild
    >
    readonly spinProps: {
      readonly type: import('vue').PropType<
    ...
    readonly onLoad: import('vue').PropType<
      import('./interface').DataTableOnLoad
    >
    readonly 'onUpdate:page': import('vue').PropType<
      import('../../_utils').MaybeArray<(page: number) => void> | undefined
    >
    readonly onUpdatePage: import('vue').PropType<
      import('../../_utils').MaybeArray<(page: number) => void> | undefined
    >
    readonly 'onUpdate:pageSize': import('vue').PropType<
      import('../../_utils').MaybeArray<(pageSize: number) => void> | undefined
    >
    readonly onUpdatePageSize: import('vue').PropType<
      import('../../_utils').MaybeArray<(pageSize: number) => void> | undefined
    >
    readonly 'onUpdate:sorter': import('vue').PropType<
      import('../../_utils').MaybeArray<import('./interface').OnUpdateSorter>
    >
    readonly onUpdateSorter: import('vue').PropType<
      import('../../_utils').MaybeArray<import('./interface').OnUpdateSorter>
    >
    readonly 'onUpdate:filters': import('vue').PropType<
      import('../../_utils').MaybeArray<import('./interface').OnUpdateFilters>
    >
    readonly onUpdateFilters: import('vue').PropType<
      import('../../_utils').MaybeArray<import('./interface').OnUpdateFilters>
    >
    readonly 'onUpdate:checkedRowKeys': import('vue').PropType<
      import('../../_utils').MaybeArray<
        import('./interface').OnUpdateCheckedRowKeys
      >
    >
    readonly onUpdateCheckedRowKeys: import('vue').PropType<
      import('../../_utils').MaybeArray<
        import('./interface').OnUpdateCheckedRowKeys
      >
    >
    readonly 'onUpdate:expandedRowKeys': import('vue').PropType<
      import('../../_utils').MaybeArray<
        import('./interface').OnUpdateExpandedRowKeys
      >
    >
    readonly onUpdateExpandedRowKeys: import('vue').PropType<
      import('../../_utils').MaybeArray<
        import('./interface').OnUpdateExpandedRowKeys
      >
    >
    readonly onScroll: import('vue').PropType<(e: Event) => void>
    readonly onPageChange: import('vue').PropType<
      import('../../_utils').MaybeArray<(page: number) => void> | undefined
    >
    readonly onPageSizeChange: import('vue').PropType<
      import('../../_utils').MaybeArray<(pageSize: number) => void> | undefined
    >
    readonly onSorterChange: import('vue').PropType<
      | import('../../_utils').MaybeArray<import('./interface').OnUpdateSorter>
      | undefined
    >
    readonly onFiltersChange: import('vue').PropType<
      | import('../../_utils').MaybeArray<import('./interface').OnUpdateFilters>
      | undefined
    >
    readonly onCheckedRowKeysChange: import('vue').PropType<
      | import('../../_utils').MaybeArray<
          import('./interface').OnUpdateCheckedRowKeys
        >
      | undefined
  ...
  },
  {
    ...
    mergedPagination: import('vue').ComputedRef<

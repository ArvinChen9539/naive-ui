...
exports.renderFilter = exports.renderSorter = void 0
const vue_1 = require('vue')
const ionicons5_1 = require('@vicons/ionicons5')
const renderSorter = ({ order }) => {
  const chevronStyle = {
    height: '16px',
    width: '16px',
    marginBottom: '-5px',
  ...
  return (0, vue_1.h)(
    ...
    [
      (0, vue_1.h)(ionicons5_1.CaretUpOutline, {
        style: Object.assign(Object.assign({}, chevronStyle), {
          marginTop: '-4px',
          color:
            order === 'ascend'
      ...
      (0, vue_1.h)(ionicons5_1.CaretDownOutline, {
        style: Object.assign(Object.assign({}, chevronStyle), {
          color:
            order === 'descend'
              ? 'var(--n-th-icon-color-active)'
...
exports.renderSorter = renderSorter
const renderFilter = ({ active, show }) => {
  const fill =

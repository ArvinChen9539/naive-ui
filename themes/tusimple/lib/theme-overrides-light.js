...
exports.themeOverridesLight = exports.colors = void 0
...
exports.themeOverridesLight = {
  common: Object.assign(
    {
      ...
      borderRadius: '16px',
      boxShadow2: vars_1.default.NORMAL_BOX_SHADOW,
      borderColor: '#999',
      dividerColor: '#EBEDF0',
      tableHeaderColor: '#EBEDF0',
      inputColorDisabled: '#EBEDF0',
      actionColor: '#EBEDF0',
      hoverColor: (0, seemly_1.changeColor)(exports.colors.primaryColor, {
        alpha: 0.1
      }),
      clearColor: (0, seemly_1.composite)('#FFF', 'rgba(0, 0, 0, .4)')
    },
    exports.colors
  ),
  Avatar: {
  ...
  BackTop: {
    ...
    iconColorHover: naive_ui_1.commonLight.primaryColor,
    iconColorPressed: naive_ui_1.commonLight.primaryColorPressed,
    boxShadow:
  ...
  Checkbox: {
    ...
    fontSizeMedium: '16px',
    borderRadius: '4px',
    borderDisabled: `1px solid ${exports.colors.textColorDisabled}`,
    borderDisabledChecked: '1px solid #0000',
    checkMarkColorDisabled: exports.colors.textColorDisabled,
    checkMarkColorDisabledChecked: '#FFF',
    colorDisabled: '#0000',
    colorDisabledChecked: '#F5F6F7 ',
    textColor: exports.colors.textColor1,
    textColorDisabled: exports.colors.textColorDisabled
  },
  Card: {
    paddingSmall: '20px',
    paddingMedium: '20px',
  ...
  DataTable: {
    ...
    thColor: '#EBEDF0',
    thIconColor: '#ccc',
    thTextColor: naive_ui_1.commonLight.textColor2,
    thFontWeight: naive_ui_1.commonLight.fontWeight,
    tdColorHover: 'rgba(79, 178, 51, .1)',
    thButtonColorHover: '#0000',
    thColorModal: '#EBEDF0',
    tdColorHoverModal: (0, seemly_1.composite)(
      naive_ui_1.commonLight.primaryColor,
      'rgba(255, 255, 255, .9)'
    ),
  ...
  Menu: {
    borderRadius: '100px',
    itemIconColor: exports.colors.textColor2
  },
  Message: {
  ...
  Pagination: {
    ...
    itemColor: '#0000',
    itemColorPressed: (0, seemly_1.composite)(
      naive_ui_1.commonLight.primaryColor,
      'rgba(255, 255, 255, 0.9)'
    ),
    itemColorHover: 'rgba(79,178,51,.1)',
    itemColorActiveHover: (0, seemly_1.composite)(
      naive_ui_1.commonLight.primaryColor,
      'rgba(255, 255, 255, 0.9)'
    ),
  ...
  Tag: {
    ...
    closeIconColor: naive_ui_1.commonLight.closeIconColor,
    closeIconColorHover: naive_ui_1.commonLight.closeIconColor,
    closeIconColorPressed: naive_ui_1.commonLight.closeIconColor,
    borderPrimary: '1px solid #0000',
    closeIconColorPrimary: naive_ui_1.commonLight.closeIconColor,
    closeIconColorHoverPrimary: naive_ui_1.commonLight.closeIconColor,
    closeIconColorPressedPrimary: naive_ui_1.commonLight.closeIconColor,
